...
function rotXFunct () { return Random.Range(maxRotX/2,maxRotX); }
function rotYFunct () { return Random.Range(maxRotY/2,maxRotY); }
function colorFunct () { return new Color(red*depth, green*depth, blue); }
...
function Update ()
{
	...
	{
		transform.Find("Node").localScale.x += rateOfGrowthFunct()*Time.deltaTime*transform.GetComponent(growing).growing;
		transform.Find("Node").localScale.y += rateOfGrowthFunct()*Time.deltaTime*transform.GetComponent(growing).growing;
		transform.Find("Node").localScale.z += rateOfGrowthFunct()*Time.deltaTime*transform.GetComponent(growing).growing;
		transform.Find("Stem").localScale.x += rateOfGrowthFunct()*Time.deltaTime*transform.GetComponent(growing).growing;
		transform.Find("Stem").localScale.z += rateOfGrowthFunct()*Time.deltaTime*transform.GetComponent(growing).growing;
	}
}